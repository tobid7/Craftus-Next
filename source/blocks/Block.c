...
#define TEXTURE_FILES                                                                                                               \
	...
	A(furnace_front,"furnace_front.png"),A(furnace_top,"furnace_top.png"), A(mycelium_top, "mycelium_top.png"), A(mycelium_side, "mycelium_side.png")
...
const char* BlockNames[Blocks_Count] = {
	...
	"Emerald_Ore","Emerald_Block","Furnace", "Mycel"
};
