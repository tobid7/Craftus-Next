...
namespace Base
{
    enum Encoder
    {
        ...
        DIRECT,         ///< Encode Direct to Framebuffer(No Decoder Required) //Not able to use in base engine
    };
    ...
    class BitmapPrinter
    {
        ...
        void DrawRect(int x, int y, int w, int h, uint8_t line_w, uint8_t b, uint8_t g, uint8_t r, uint8_t a);
        void DrawRectFilled(int x, int y, int w, int h, uint8_t b, uint8_t g, uint8_t r, uint8_t a);
