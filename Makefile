...
SOURCES		:=	source source/misc source/world/worldgen source/world/worldgen/structures source/blocks source/rendering source/gui source/world source/world/savegame source/entity source/savegame dependencies/mpack dependencies/vec dependencies/sino dependencies/lodepng dependencies/miniz dependencies/ini
DATA		:=	data
