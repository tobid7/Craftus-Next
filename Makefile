...
UNIVCORE	:=	deps/Npi deps/Npi/RObjects deps/Npi/RObjects/mesh deps/PerlinNoise
...
GFXBUILD	:=	$(ROMFS)
APP_AUTHOR	:=	Tobi-D7
APP_DESCRIPTION :=      Craftus-Next in c++.
ICON		:=	app/icon.png
...
$(OUTPUT).cia	:	$(OUTPUT).elf $(OUTPUT).smdh
	...
	$(MAKEROM) -f cia -target t -exefslogo -o "../Craftus-Next.cia" -elf "../Craftus-Next.elf" -rsf "../app/build-cia.rsf" -banner "../app/banner.bin" -icon "../app/icon.bin" -logo "../app/splash.lz" -DAPP_ROMFS="$(TOPDIR)/$(ROMFS)" -major $(VERSION_MAJOR) -minor $(VERSION_MINOR) -micro $(VERSION_MICRO) -DAPP_VERSION_MAJOR="$(VERSION_MAJOR)"
#---------------------------------------------------------------------------------
